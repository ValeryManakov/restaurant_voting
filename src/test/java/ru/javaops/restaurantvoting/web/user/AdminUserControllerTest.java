...
import ru.javaops.restaurantvoting.web.GlobalExceptionHandler;
...
import static ru.javaops.restaurantvoting.web.user.UserTestData.*;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin, user, user10, user11, user12, user3, user4, user5, user6, user7, user8, user9));
    }
